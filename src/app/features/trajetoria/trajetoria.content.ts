export const trajetoriaExperience = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Desenvolvimento de novas features com foco em valor de produto e experiência do cliente',
      'Melhoria de latência em fluxos críticos de pagamento',
      'Evolução de padrões de observabilidade e resiliência',
    ],
  },
  {
    company: 'dti digital',
...
export const trajetoriaEducation = [
  {
    institution: 'FIAP',
